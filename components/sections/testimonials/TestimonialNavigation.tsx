...
const TestimonialNavigation = memo(
  function TestimonialNavigation({}: TestimonialNavigationProps) {
    return (
      <div className='flex items-center justify-center space-x-4'>
        {/* Previous Button */}
        <button className={BUTTON_STYLES} aria-label='Previous testimonial'>
          <ChevronLeft className='w-5 h-5 text-gray-600' />
        </button>

        {/* Next Button */}
        <button className={BUTTON_STYLES} aria-label='Next testimonial'>
