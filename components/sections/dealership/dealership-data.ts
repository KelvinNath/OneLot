...
export const dealershipData = {
  ...
  description:
    "OneLot's digital platform has been built with the single goal to help used car dealers to operate their business more efficiently.",
  features: [
    {
    ...
    },
    {
      ...
      description:
        'Get insights on prices and volumes for all cars in the market. We provide you all the data by combining data from various sources with a single click of a button',
    },
  ],
